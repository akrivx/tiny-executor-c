...
typedef enum texec_structure_type {
  ...
  TEXEC_STRUCTURE_TYPE_SUBMIT_INFO                      = 0x2000,
  ...
  TEXEC_STRUCTURE_TYPE_SUBMIT_PRIORITY                  = 0x2001,
  TEXEC_STRUCTURE_TYPE_SUBMIT_DEADLINE                  = 0x2002,
  TEXEC_STRUCTURE_TYPE_SUBMIT_TRACE_CONTEXT             = 0x2003,
  TEXEC_STRUCTURE_TYPE_SUBMIT_BACKPRESSURE              = 0x2004,
